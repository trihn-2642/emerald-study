...
| File                                            | Mô tả                                                                                           |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| `src/app/(auth)/dashboard/page.tsx`             | Server Component: 3 Suspense boundaries + FAB                                                   |
| `src/app/(auth)/dashboard/loading.tsx`          | Skeleton loading cho dashboard                                                                  |
...
| File                                  | Thay đổi                                                                           |
| ------------------------------------- | ---------------------------------------------------------------------------------- |
| `src/app/(auth)/layout.tsx`           | Fetch user với `getUser()`, pass `userName`/`userEmail` xuống AppShell, auth guard |
...
- [x] Auth guard trong `(auth)/layout.tsx`
...
| File                                           | Mô tả                                                                                        |
| ---------------------------------------------- | -------------------------------------------------------------------------------------------- |
| `src/app/(auth)/dashboard/page.tsx`            | Server Component: fetch data từ Supabase qua `getTodayStats`, `getDueDecks`, `getUserStreak` |
...
| `src/app/(auth)/dashboard/loading.tsx`         | Skeleton loading UI khi Dashboard đang fetch data                                            |
...
| File                                 | Thay đổi                                                             |
| ------------------------------------ | -------------------------------------------------------------------- |
| `src/app/(auth)/layout.tsx`          | Fetch user, pass `userName`/`userEmail` xuống `AppShell`, auth guard |
...
| File                                           | Mô tả                                                                 |
| ---------------------------------------------- | --------------------------------------------------------------------- |
| `src/app/(auth)/dashboard/page.tsx`            | Server Component: fetch data, render layout Dashboard                 |
...
| File                      | Thay đổi                   |
| ------------------------- | -------------------------- |
| `src/app/(auth)/page.tsx` | Redirect sang `/dashboard` |
